export const RETRO_PYTHON_SCRIPT = `"""
================================================================================
...
class RetroSdrApp(ctk.CTk):
    ...
    def _setup_ui(self):
        ...
        # ROW 2: Massive Quick Tally Buttons
        ...
        entry_frame.grid_columnconfigure(4, weight=0)
        ...
        # ROW 4: Retro CRT Activity Terminal
    ...
    def handle_start_shift(self):
        ...
        self.shift_status_lbl.configure(text="STATUS: [ACTIVE] // LOGGING SHIFT OFFSET", text_color=COLOR_NEON_GREEN)
    ...
    def handle_pause_shift(self):
        if shift_state["status"] == "active":
            ...
            self.shift_status_lbl.configure(text="STATUS: [PAUSED] // SHIFT CHRONO HALTED", text_color=COLOR_NEON_AMBER)
    ...
    def handle_end_shift(self):
        ...
        shift_state["running"] = False
        self.shift_status_lbl.configure(text="STATUS: [COMPLETED] // SHIFT ARCHIVED", text_color=COLOR_NEON_PINK)
...
export const RETRO_SPEC_FILE = `# -*- mode: python ; coding: utf-8 -*-
"""
...
# Collect CustomTkinter theme assets & fonts
datas = collect_data_files('customtkinter')

# Collect Uvicorn, FastAPI, and Pydantic submodules for standalone daemon
hiddenimports = [
    'customtkinter',
    'fastapi',
    'uvicorn',
...
exe = EXE(
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=False,  # Set to False to prevent black CMD window from showing
...
export const RETRO_BAT_SCRIPT = `@echo off
echo ==============================================================================
